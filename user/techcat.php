				...
				<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
							...
							<li class="nav-item">
								<a class="nav-link" href="cart.php"><img src="../images/icons/cart.ico" alt="">Cart <span class="sr-only">(current)</span></a>
							</li>
				...
				<div class="row">
					<div class="col-lg-3">
						...
						<div class="list-group">
							<a href="halamanbuku.php" class="list-group-item">Educational</a>
							<a href="catfiction.php" class="list-group-item">Fiction</a>
							<a href="techcat.php" class="list-group-item active">Technology</a>
							<br><br><br><br>
						</div>
					</div>
					<!-- category -->
					<div class="col-lg-9">
						<div class="row">
							...
							$sql = "SELECT * FROM tb_buku WHERE id_kategori='3'";
