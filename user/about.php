			...
			<div id="navigation-bar">
				<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<form class="form-inline my-2 my-lg-0" action="../phpuser/searchengine.php" method="POST">
			...
			<div class="container">
				<div class="from-group col">
					<div class="form-group">
						<form  action="../phpuser/connectmailer.php" method="POST">
							<br style="clear:both">
							...
							<button type="submit" type="submit" value="submit" name="submit" class="btn btn-primary pull-right">Submit</button>
						</form>
					</div>
				</div>
			</div>
